...
@Component({
  selector: 'app-limitesacessoporip-blacklist',
  template: `
      <pandora-table
        [value]="dados"
...
export class LimitesAcessoPorIPBlacklistComponent implements OnInit, OnDestroy {
  ...
  getLimiteAcesso() {
    this.sistema.getLimitesAcessoPorIPBlacklist(null)
