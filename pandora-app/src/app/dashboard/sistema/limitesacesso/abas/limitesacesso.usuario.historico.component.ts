...
@Component({
  selector: 'app-limitesacessoporusuario-historico',
  template: `
      <pandora-table
        [value]="dados"
...
export class LimitesAcessoPorUsuarioHistoricoComponent implements OnInit, OnDestroy {
  ...
  getLimiteAcesso() {
    this.sistema.getLimitesAcessoPorUsuarioHistorico(null)
