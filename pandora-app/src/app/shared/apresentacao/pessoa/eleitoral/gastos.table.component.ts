...
export class GastosTableComponent implements AfterViewInit, OnChanges {
  ...
  dicionarioDados = {
      ...
      // nome    : { nome: 'Nome' },
      qtd   : { nome: 'Qtd Gastos' },
      menor   : { nome: 'Menor Gasto' },
      maior   : { nome: 'Maior Gasto' },
      media   : { nome: 'Média' },
