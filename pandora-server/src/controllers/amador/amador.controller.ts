...
import {
    procuraAmadorDetalhadoCPF
} from './amador.functions';
...
export let getAmadorDetalhadoCPF = function (req: Request, res: Response){
    ...
    if(validaCPF(cpf)){
        ...
        cf(log, procuraAmadorDetalhadoCPF, cpf)
            .then(amador => res.status(200).send(amador))
