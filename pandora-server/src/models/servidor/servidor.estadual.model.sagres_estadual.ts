...
const fonte  = MODEL_PRIORITY['sagres_estadual.vw_folha'].fonte;
const rank   = MODEL_PRIORITY['sagres_estadual.vw_folha'].rank;
const grupo  = MODEL_PRIORITY['sagres_estadual.vw_folha'].grupo;

export let getServidorEstadualSimplificadoCPF_BD_Sagres = function(cpf: string){
...
export let getServidorEstadualDetalhadoCPF_BD_Sagres = function(cpf: string){
