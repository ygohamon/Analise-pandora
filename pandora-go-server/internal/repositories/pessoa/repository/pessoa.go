...
// pessoaIntegradoLocalModel orquestra fontes locais para o integrado por CPF.
type pessoaIntegradoLocalModel struct {
	pessoaStore
}

// pessoaIntegradoExternoModel orquestra fontes externas para o integrado por CPF.
