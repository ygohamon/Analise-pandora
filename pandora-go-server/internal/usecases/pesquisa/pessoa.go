...
func NewPessoaUseCase(repo repositories.IntegradoPessoaRepository, crawler ...CrawlerSearchPort) PessoaUseCase {
	return PessoaUseCase{repo: repo, integrado: NewIntegradoCPFUseCase(repo, crawler...)}
}
