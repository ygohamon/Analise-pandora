...
func NewEmpresaUseCase(repo repositories.IntegradoEmpresaRepository, crawler ...CrawlerSearchPort) EmpresaUseCase {
	return EmpresaUseCase{repo: repo, integrado: NewIntegradoEmpresaUseCase(repo, crawler...)}
}
